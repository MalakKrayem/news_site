              ...
              <div class="card" data-aos="fade-up">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      <?php
                      $query="select * from posts where cat_id=$id LIMIT 6";
                      $res=mysqli_query($conn,$query);
                      if($res && $res->num_rows>0){
                    ...
                    <div class="col-lg-4">
                      ...
                      <?php
                      $query="select * from posts where cat_id=$id ORDER BY id DESC LIMIT 3";
                      $res=mysqli_query($conn,$query);
                      if($res && $res->num_rows>0){
                        while($post=$res->fetch_assoc()){
                         $title=$post['title'];
                          ...
                          <div class="border-bottom pb-4 pt-4">
                            <div class="row">
                              <div class="col-sm-8">
                                ...
                                <p class="fs-13 text-muted mb-0">
                                  <span class="mr-2"><?php echo $type;?> </span><?php echo $dateiff;?>
                                </p>
                              </div>
                              <div class="col-sm-4">
                                <div class="rotate-img">
                     ...
                     ?>
                      ...
                      <div class="trending">
                        ...
                        <?php
                        $query="select * from posts where cat_id=$id ORDER BY RAND()  LIMIT 3";
                        $res=mysqli_query($conn,$query);
                        if($res && $res->num_rows>0){
                          while($post=$res->fetch_assoc()){
                            $title=$post['title'];
