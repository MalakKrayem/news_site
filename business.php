              ...
              <div class="card" data-aos="fade-up">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      <?php
                      $query="select * from posts where cat_id=17 LIMIT 6";
                    ...
                    <div class="col-lg-4">
                      ...
                      <?php
                      $query="select * from posts where cat_id=17 ORDER BY id DESC LIMIT 3";
                      $res=mysqli_query($conn,$query);
                      if($res && $res->num_rows>0){
                        while($post=$res->fetch_assoc()){
                         $title=$post['title'];
                     ...
                     ?>
                      ...
                      <div class="trending">
                        ...
                        <?php
                        $query="select * from posts where cat_id=17 ORDER BY RAND()  LIMIT 3";
                        $res=mysqli_query($conn,$query);
                        if($res && $res->num_rows>0){
                          while($post=$res->fetch_assoc()){
                            $title=$post['title'];
